...
// end include: /tmp/tmp4ypfq4n0.js
// include: /tmp/tmptnua07cr.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmptnua07cr.js
// include: /tmp/tmpfadk1vg_.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpfadk1vg_.js
...
var ASM_CONSTS = {
 ...
 124484: () => { return Module.canvas.width; },  
 124516: () => { return parseInt(Module.canvas.style.width); },  
 124564: () => { document.exitFullscreen(); },  
 124591: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 124663: () => { if (document.fullscreenElement) return 1; },  
 124709: () => { return Module.canvas.width; },  
 124741: () => { return screen.width; },  
 124766: () => { document.exitFullscreen(); },  
 124793: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 124987: () => { return window.innerWidth; },  
 125013: () => { return window.innerHeight; },  
 125040: () => { if (document.fullscreenElement) return 1; },  
 125086: () => { return Module.canvas.width; },  
 125118: () => { return parseInt(Module.canvas.style.width); },  
 125166: () => { if (document.fullscreenElement) return 1; },  
 125212: () => { return Module.canvas.width; },  
 125244: () => { return screen.width; },  
 125269: () => { return window.innerWidth; },  
 125295: () => { return window.innerHeight; },  
 125322: () => { if (document.fullscreenElement) return 1; },  
 125368: () => { return Module.canvas.width; },  
 125400: () => { return screen.width; },  
 125425: () => { document.exitFullscreen(); },  
 125452: () => { if (document.fullscreenElement) return 1; },  
 125498: () => { return Module.canvas.width; },  
 125530: () => { return parseInt(Module.canvas.style.width); },  
 125578: () => { document.exitFullscreen(); },  
 125605: ($0) => { Module.canvas.style.opacity = $0; },  
 125643: () => { return screen.width; },  
 125668: () => { return screen.height; },  
 125694: () => { return window.screenX; },  
 125721: () => { return window.screenY; },  
 125748: () => { return window.devicePixelRatio; },  
 125784: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 125837: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 125888: () => { Module.canvas.style.cursor = 'none'; },  
 125925: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 126181: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 126232: () => { if (document.pointerLockElement) return 1; },  
 126279: () => { if (document.fullscreenElement) return 1; },  
 126325: () => { return window.innerWidth; },  
 126351: () => { return window.innerHeight; }
};
